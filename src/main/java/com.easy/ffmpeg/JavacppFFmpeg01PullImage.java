 ...
 * ffmpeg拉流（视频源可以是文件和流媒体（rtsp/rtmp/hls/flv等等））
 *
 * 2、将视频帧解码为yuvj420p图像数据
 *
 * 3、将yuvj402p图像数据保存为jpg图片
 */
public class JavacppFFmpeg01PullImage {
    /**
     ...
     * @author eguid
     */
    private static int openVideo(String url, String out_file) throws IOException {
     ...
     * @author eguid
     */
    private static int saveImg(avutil.AVFrame pFrame, String out_file) {
   ...
   openVideo("E:\\tmp\\1.flv","E:\\tmp\test.jpg");
